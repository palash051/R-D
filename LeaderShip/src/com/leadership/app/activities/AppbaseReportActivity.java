	...
	public void initialization() {
		...
		if(!isCompare){
			...
			if(CommonValues.getInstance().LoginUser.UserMode!=3)
				URL = "http://120.146.188.232:9050/AppCoverageCompare.aspx?reqd="+ selectedCityIds;
			else
				URL = "http://120.146.188.232:9050/OpeAppCoverageCompare.aspx?reqd="+ selectedCityIds;
		}
