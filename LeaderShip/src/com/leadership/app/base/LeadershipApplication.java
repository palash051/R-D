package com.leadership.app.base;
...
public class LeadershipApplication extends Application{
	...
	private void setUpDefaultImageOptions(){
       ...
       // BitmapAjaxCallback.setPixelLimit(AQuery.RATIO_PRESERVE);
		...
		CommonValues.getInstance().defaultImageOptions.fallback=R.drawable.leadership;
