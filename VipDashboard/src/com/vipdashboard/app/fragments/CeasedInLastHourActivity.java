...
public class CeasedInLastHourActivity extends MainActionbarBase implements OnQueryTextListener, OnItemClickListener, IAsynchronousTask, OnClickListener {
	...
	int count, loadMessageCeasedAlarms;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		titleText.setText("Ceased In Last Hour");
		loadMessage = (TextView) findViewById(R.id.tvShowMeMore);
		CommonTask.makeLinkedTextview(this, loadMessage, loadMessage.getText().toString());
		...
		loadMessage.setOnClickListener(this);
	}
	...
	protected void onResume() {
		...
		count = 0;
		loadMessageCeasedAlarms = (++count)*CommonConstraints.USER_MESSAGE_COUNT;
		LoadAlarmList();
		super.onResume();
	}
	...
	public Object doBackgroundPorcess() {
		...
		return liveAlarmManager.GetCeasedInLastHour();
	}
