...
public class ListViewHistoryApdater extends BaseAdapter {
	...
	public ListViewHistoryApdater(Context context, List<HistoryItem> listData) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mInflater.inflate(R.layout.activity_history_item,
					null);
		...
		holder.description.setText(String.format("%f",listData.get(position).getCache()));
		/*
