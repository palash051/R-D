...
public class CircularProgressBar extends ProgressBar{
	...
	public void init(AttributeSet attrs, int style){
		...
		color = a.getString(R.styleable.CircularProgressBar_progressbarColor);
		if(color==null)
		...
		String t = a.getString(R.styleable.CircularProgressBar_text);
		if(t!=null)
			mTitle = t;

		t = a.getString(R.styleable.CircularProgressBar_subtext);
		if(t!=null)
			mSubTitle = t;
