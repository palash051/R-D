 ...
 *******************************************************************************/
package com.vipdashboard.app.customcontrols;
...
public class GaugeView extends View {
	...
	public static final float NEEDLE_HEIGHT = 0.4f;
	...
	public static final float[] RANGE_VALUES = { 31.0f, 61.0f, 100.0f };
	public static final int[] RANGE_COLORS = { Color.rgb(231, 32, 43),  Color.rgb(232, 231, 33),
			Color.rgb(27, 202, 33) };
	...
	public void initDrawingRects() {
		...
		mInnerRimRect=new RectF(LEFT, TOP, RIGHT, BOTTOM);
	...
	public Paint getDefaultNeedleRightPaint() {
		...
		paint.setShadowLayer(0.01f, 0.005f, -0.005f, Color.argb(220, 220, 220, 0));
	...
	public void setDefaultScaleRangePaints() {
		...
		for (int i = 0; i < length; i++) {
			...
			mRangePaints[i].setTextSize(0.08f);
	...
	private void drawText(final Canvas canvas) {
		...
		final float startY = CENTER + 0.28f;
