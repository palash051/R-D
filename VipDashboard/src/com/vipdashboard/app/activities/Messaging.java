...
import com.vipdashboard.app.base.IMService;
...
public class Messaging extends Activity {
	...
	//	friendUserName.setText(friend.userName);
		...
		if (msg != null) 
		{
			this.appendToMessageHistory(extras.getString("username") , msg);
			...
			public void onClick(View arg0) {
				...
				{		
					...
					Thread thread = new Thread(){					
						public void run() {
							if (!imService.sendMessage("", message.toString()))
							{
	...
	public class  MessageReceiver extends BroadcastReceiver {
		...
		{		
			...
			String username = extra.getString("");			
			String message = extra.getString("message");
			
			appendToMessageHistory("User2", message);
