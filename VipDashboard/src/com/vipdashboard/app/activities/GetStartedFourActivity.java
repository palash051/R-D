...
public class GetStartedFourActivity extends SherlockFragment implements
		OnClickListener {
	Button gpbtnsign, gpbtnjoin;
	ImageView getstartedfour;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.getstartedpagefour,
				container, false);

		gpbtnsign = (Button) rootView.findViewById(R.id.gpbtnsign);
		gpbtnjoin = (Button) rootView.findViewById(R.id.gpbtnjoin);
		getstartedfour = (ImageView) rootView.findViewById(R.id.getstartedfour);
		...
		if (IsNeedtoSkipLogin) {
			...
			RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) getstartedfour
					.getLayoutParams();
			layoutParams.addRule(RelativeLayout.ALIGN_PARENT_BOTTOM,
					RelativeLayout.TRUE);
			getstartedfour.setLayoutParams(layoutParams);
