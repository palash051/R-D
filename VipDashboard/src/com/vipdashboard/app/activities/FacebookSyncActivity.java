...
public class FacebookSyncActivity extends Activity implements OnClickListener {
	
	ImageView ivProfilePicture, ivSyncWithOutFacebook, ivSyncWithFacebook;
	...
	public void onClick(View view) {
		if(view.getId() == R.id.ivSyncWithOutFacebook){
			...
			Intent intent = new Intent(this,FacebookSyncPreviewActivity.class);
			intent.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
			startActivity(intent);
		}
	}
