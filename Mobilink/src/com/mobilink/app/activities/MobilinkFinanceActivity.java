...
public class MobilinkFinanceActivity extends Activity implements
		OnClickListener {

	AQuery aq;
	ImageView ivOperatorIcon, ivFinance,ivOperatorCompare,ivOperatorNetworkKpi;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.mobilink_finance);
		Initialization();
	...
	public void onClick(View view) {
		...
		if (view.getId() == R.id.rlSUBSCRIBER) {
			...
			MobilinkOperatorCompareActivity.ReportType="Finance";
			...
			Intent intent = new Intent(this, MobilinkNetworkKPIVoiceDataActivity.class);
			intent.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
			startActivity(intent);
		}
