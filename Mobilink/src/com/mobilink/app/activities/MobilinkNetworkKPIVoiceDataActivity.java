...
public class MobilinkNetworkKPIVoiceDataActivity extends Activity implements
		OnClickListener {
	...
	TextView tv3G_call_Setup_success_rate, tv3G_Drop_Rate,
			...
			tvEDGE_performance, tvGB_per_Subscriber,tvDataCityWiseComparision;
	
	ImageView ivOperatorCompare,ivOperatorNetworkKpi,ivOperatorIcon,ivDown_Link_Speed,ivDataCoverage,ivAppCoverage;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.mobilink_network_kpi_voice);
		Initialization();
	}
	...
	public void onClick(View view) {
		if (view.getId() == R.id.rlVoice_happiness) {
			...
			Intent intent = new Intent(this,
					MobilinkNetworkKPIDownloadActivity.class);
			...
			Intent intent = new Intent(this,MobilinkNetworkKPIDownloadActivity.class);
			intent.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
			startActivity(intent);
